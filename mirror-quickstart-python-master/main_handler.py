...
class MainHandler(webapp2.RequestHandler):
  ...
  def post(self):
    ...
    operations = {
        ...
        'sendColor': self._sendColor,
        'addContact': self._addContact,
        'colorSubscription': self._colorSubscription
    }
  ...
  def _colorSubscription(self):
    body = {
        'collection': 'timeline',
        'callbackUrl': 'https://robust-atrium-254.appspot.com',
        'operation': 'UPDATE',
  ...
  def _sendColor(self):
    body = {
        'notification': {'level': 'DEFAULT'},
        'html': '<article>\n  <section>\n    <div class=\"layout-figure\">\n      <div class=\"align-center\">\n<p>Najdi mě!</p>\n<p>R: 45</p>\n<p>G: 50</p>\n<p>B: 46</p>\n</div>\n      <div>\n        <div class=\"text-normal\" style=\"background-color:#2D322E\">\n        <br><br><br><br><br>\n        </div>\n      </div>\n    </div>\n  </section>\n</article>'
    }
    if self.request.get('html') == 'on':
        body['html'] = [self.request.get('message')]
    else:
  ...
  def _addContact(self):
    body = {
        'id': 'unique_name',
        'displayName': 'Color glass',
        'imageUrls': ['http://marketingland.com/wp-content/ml-loads/2013/05/google-my-glass-icon.png'],
        'priority': 1
    }
